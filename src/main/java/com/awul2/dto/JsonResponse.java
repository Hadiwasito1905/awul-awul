...
public class JsonResponse<T> {
    ...
    public static final String ERROR_CODE_UNAUTHORIZED = "4020";
    public static final String ERROR_CODE_TOKEN_EXPIRED = "4021";
    ...
    public static <T> JsonResponse<T> error(String status, String message) {
